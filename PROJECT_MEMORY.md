...
- **Corrected Gemini SDK Usage Metadata Access (19.01.2026):** Fixed a runtime bug in the LLM adapter where `usageMetadata` was incorrectly invoked as a method. This ensures reliable token tracking and telemetry for all LLM-driven summarization and architectural analysis tasks.
